...
# define MYSTIC_ARCH_COMPILER_VERSION_STR \
    MYSTIC_STRINGIFY(MYSTIC_ARCH_COMPILER_VERSION_MAJOR) "." MYSTIC_STRINGIFY(MYSTIC_ARCH_COMPILER_VERSION_MINOR)

/**
 * @brief Levels of version in string.
 */
# define MYSTIC_ARCH_COMPILER_VERSION_MAJOR_STR MYSTIC_STRINGIFY(MYSTIC_ARCH_COMPILER_VERSION_MAJOR)
# define MYSTIC_ARCH_COMPILER_VERSION_MINOR_STR MYSTIC_STRINGIFY(MYSTIC_ARCH_COMPILER_VERSION_MINOR)
# define MYSTIC_ARCH_COMPILER_VERSION_PATCH_STR MYSTIC_STRINGIFY(MYSTIC_ARCH_COMPILER_VERSION_PATCH)
 ...
 */
# define MYSTIC_ARCH_COMPILER_VERSION_STR \
    MYSTIC_STRINGIFY(MYSTIC_ARCH_COMPILER_VERSION_MAJOR) "." MYSTIC_STRINGIFY(MYSTIC_ARCH_COMPILER_VERSION_MINOR) "." MYSTIC_STRINGIFY(MYSTIC_ARCH_COMPILER_VERSION_PATCH)
