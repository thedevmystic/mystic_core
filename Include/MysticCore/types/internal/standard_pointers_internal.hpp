 ...
 * ------------------------------------------------------------------------------------------------------
 *
 * @path [ROOT]/include/mystic/types/internal/standard_pointers_internal.hpp
 * @file standard_pointers_internal.hpp
 * @brief Internal implementation of standard pointers types.
 *
